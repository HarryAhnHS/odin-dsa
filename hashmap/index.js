// Testing -- adapted from @TBogdanE submission
...
hashMap.remove("flower");
hashMap.set("language3", "C++");

console.log("get(movie3):", hashMap.get("movie3"));
console.log("get(element):", hashMap.get("element"));
console.log("get(22):", hashMap.get(22));
console.log("has(22):", hashMap.has(22));
console.log("has(language3):", hashMap.has("language3"));
console.log("has(language4):", hashMap.has("language4"));

hashMap.remove("language3");
console.log("has(language3):", hashMap.has("language3"));

console.log("length:", hashMap.length());
console.log("values:", hashMap.values());
console.log("entries:", hashMap.entries());
console.log("table:", hashMap.table);
...
console.log("values:", hashMap.values());
console.log("entries:", hashMap.entries());
console.log("table:", hashMap.getTable());